...
import plugily.projects.villagedefense.creatures.v1_10_R1.BabyZombie;
import plugily.projects.villagedefense.creatures.v1_10_R1.FastZombie;
import plugily.projects.villagedefense.creatures.v1_10_R1.GolemBuster;
import plugily.projects.villagedefense.creatures.v1_10_R1.HardZombie;
import plugily.projects.villagedefense.creatures.v1_10_R1.PlayerBuster;
import plugily.projects.villagedefense.creatures.v1_10_R1.RidableIronGolem;
import plugily.projects.villagedefense.creatures.v1_10_R1.RidableVillager;
import plugily.projects.villagedefense.creatures.v1_10_R1.TankerZombie;
import plugily.projects.villagedefense.creatures.v1_10_R1.VillagerBuster;
import plugily.projects.villagedefense.creatures.v1_10_R1.VillagerSlayer;
import plugily.projects.villagedefense.creatures.v1_10_R1.WorkingWolf;
import plugily.projects.villagedefense.handlers.language.Messages;

import java.util.Random;

public class ArenaInitializer1_10_R1 extends Arena {

  private World world;
  private final Main plugin;

  public ArenaInitializer1_10_R1(String id, Main plugin) {
    super(id);
    this.plugin = plugin;
  }
  ...
  public void spawnVillager(Location location) {
    ...
    ((CraftWorld) location.getWorld()).getHandle().addEntity(ridableVillager, CreatureSpawnEvent.SpawnReason.CUSTOM);
