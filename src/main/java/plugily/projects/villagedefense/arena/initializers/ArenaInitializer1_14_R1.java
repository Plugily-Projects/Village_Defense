...
import plugily.projects.villagedefense.creatures.v1_14_R1.BabyZombie;
import plugily.projects.villagedefense.creatures.v1_14_R1.FastZombie;
import plugily.projects.villagedefense.creatures.v1_14_R1.GolemBuster;
import plugily.projects.villagedefense.creatures.v1_14_R1.HardZombie;
import plugily.projects.villagedefense.creatures.v1_14_R1.PlayerBuster;
import plugily.projects.villagedefense.creatures.v1_14_R1.RidableIronGolem;
import plugily.projects.villagedefense.creatures.v1_14_R1.RidableVillager;
import plugily.projects.villagedefense.creatures.v1_14_R1.TankerZombie;
import plugily.projects.villagedefense.creatures.v1_14_R1.VillagerBuster;
import plugily.projects.villagedefense.creatures.v1_14_R1.VillagerSlayer;
import plugily.projects.villagedefense.creatures.v1_14_R1.WorkingWolf;
...
public class ArenaInitializer1_14_R1 extends Arena {
  ...
  public ArenaInitializer1_14_R1(String id, Main plugin) {
    super(id);
    this.plugin = plugin;
  }
  ...
  public void spawnKnockbackResistantZombies(Random random) {
    ...
    fastZombie.getAttributeInstance(GenericAttributes.KNOCKBACK_RESISTANCE).setValue(Double.MAX_VALUE);
    fastZombie.setPosition(location.getX(), location.getY(), location.getZ());
    world.addEntity(fastZombie, CreatureSpawnEvent.SpawnReason.CUSTOM);
    Zombie zombie = (Zombie) fastZombie.getBukkitEntity();
