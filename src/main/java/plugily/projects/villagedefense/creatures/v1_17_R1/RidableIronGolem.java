...
public class RidableIronGolem extends EntityIronGolem {
  ...
  public RidableIronGolem(World world) {
    ...
    bO.a(1, new PathfinderGoalMeleeAttack(this, 1.0D, true));
    bO.a(2, new PathfinderGoalMoveTowardsTarget(this, 0.9D, 32.0F));
    bO.a(3, new PathfinderGoalMoveThroughVillage(this, 0.6D, false, 4, () -> false));
    bO.a(4, new PathfinderGoalMoveTowardsRestriction(this, 1.0D));
    bO.a(5, new PathfinderGoalRandomStroll(this, 0.6D));
    bO.a(6, new PathfinderGoalLookAtPlayer(this, EntityHuman.class, 6.0F));
