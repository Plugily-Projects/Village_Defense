...
public class RidableVillager extends EntityVillager {
  ...
  public RidableVillager(World world) {
    ...
    bO.a(1, new PathfinderGoalAvoidTarget<>(this, EntityZombie.class,
        8.0F, 0.6D, 0.6D));
    bO.a(1, new PathfinderGoalTradeWithPlayer(this));
    bO.a(1, new PathfinderGoalLookAtTradingPlayer(this));
    //todo
    //this.bO.a(2, new PathfinderGoalMoveIndoors(this));
    //this.bO.a(3, new PathfinderGoalRestrictOpenDoor(this));
    //this.bO.a(4, new PathfinderGoalOpenDoor(this, true));
    bO.a(5, new PathfinderGoalMoveTowardsRestriction(this, 0.6D));
    //this.bO.a(6, new PathfinderGoalMakeLove(this));
    //this.bO.a(8, new PathfinderGoalPlay(this, 0.32D));
    bO.a(9, new PathfinderGoalInteract(this, EntityHuman.class,
        3.0F, 1.0F));
    bO.a(9, new PathfinderGoalInteract(this, EntityVillager.class,
        5.0F, 0.02F));
    bO.a(9, new PathfinderGoalRandomStroll(this, 0.6D));
    bO.a(10, new PathfinderGoalLookAtPlayer(this, EntityInsentient.class, 8.0F));
  }
