...
public class BabyZombie extends EntityZombie {
  ...
  public BabyZombie(World world) {
    ...
    bP.a(2, new PathfinderGoalZombieAttack(this, CreatureUtils.getBabyZombieSpeed(), false));
    bP.a(4, new PathfinderGoalMoveTowardsRestriction(this, CreatureUtils.getBabyZombieSpeed()));
