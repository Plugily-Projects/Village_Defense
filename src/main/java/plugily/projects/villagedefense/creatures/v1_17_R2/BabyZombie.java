...
public class BabyZombie extends EntityZombie {
  ...
  public BabyZombie(World world) {
    ...
    bQ.a(2, new PathfinderGoalZombieAttack(this, CreatureUtils.getBabyZombieSpeed(), false));
    bQ.a(4, new PathfinderGoalMoveTowardsRestriction(this, CreatureUtils.getBabyZombieSpeed()));
