...
public class PlayerBuster extends EntityZombie {
  ...
  public PlayerBuster(World world) {
    ...
    bP.a(7, new PathfinderGoalLookAtPlayer(this, EntityPlayer.class, 8.0F)); // this one to look at human
    bP.a(7, new PathfinderGoalRandomLookaround(this));
    bQ.a(1, new PathfinderGoalHurtByTarget(this));
    bQ.a(2, new PathfinderGoalNearestAttackableTarget<>(this, EntityPlayer.class, true));// this one to target
