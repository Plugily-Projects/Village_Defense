...
public class TankerZombie extends EntityZombie {
  ...
  public TankerZombie(World world) {
    ...
    bQ.a(4, new PathfinderGoalNearestAttackableTarget<>(this, EntityHuman.class, true)); // this one to target human
    bQ.a(2, new PathfinderGoalNearestAttackableTarget<>(this, EntityVillager.class, false));
    bQ.a(3, new PathfinderGoalNearestAttackableTarget<>(this, EntityIronGolem.class, false));
    setHealth(35);
