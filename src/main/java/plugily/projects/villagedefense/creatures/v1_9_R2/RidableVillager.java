...
import net.minecraft.server.v1_9_R2.PathfinderGoalLookAtTradingPlayer;
import net.minecraft.server.v1_9_R2.PathfinderGoalMakeLove;
...
import net.minecraft.server.v1_9_R2.PathfinderGoalPlay;
import net.minecraft.server.v1_9_R2.PathfinderGoalRandomStroll;
import net.minecraft.server.v1_9_R2.PathfinderGoalRestrictOpenDoor;
import net.minecraft.server.v1_9_R2.PathfinderGoalTradeWithPlayer;
...
public class RidableVillager extends EntityVillager {
  ...
  public RidableVillager(World world) {
    ...
    goalSelector.a(1, new PathfinderGoalAvoidTarget<>(this, EntityZombie.class, 8.0F, 0.6D, 0.6D));
