...
public class WorkingWolf extends EntityWolf {
  ...
  public WorkingWolf(World world) {
    ...
    this.goalSelector.a(4, new net.minecraft.server.v1_9_R2.PathfinderGoalMeleeAttack(this, 1.0D, true));
    ...
    this.goalSelector.a(7, new PathfinderGoalLookAtPlayer(this, net.minecraft.server.v1_9_R2.EntityHuman.class, 6.0F));
