...
package pl.plajer.villagedefense3.plajerlair.core.services;
...
public class ReportedException {
  ...
  private pl.plajer.villagedefense3.plajerlair.core.services.ReporterService reporterService;

  public ReportedException(JavaPlugin plugin, Exception e) {
    e.printStackTrace();
    if (!pl.plajer.villagedefense3.plajerlair.core.services.ServiceRegistry.getRegisteredPlugins().contains(plugin)) {
      return;
    }
    if (System.currentTimeMillis() - pl.plajer.villagedefense3.plajerlair.core.services.ServiceRegistry.getServiceCooldown().getOrDefault(plugin, 0L) < 900000) {
      return;
    }
