...
public class ServiceRegistry {
  ...
  private static pl.plajer.villagedefense3.plajerlair.core.services.LocaleService localeService;
  ...
  public static boolean registerService(JavaPlugin plugin) {
    ...
    localeService = new pl.plajer.villagedefense3.plajerlair.core.services.LocaleService(plugin);
    return true;
  }
