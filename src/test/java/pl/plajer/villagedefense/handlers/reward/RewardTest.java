...
public class RewardTest {
  ...
  public void getExecutor() {
    ...
    System.out.println("> Reward#getExecutor true for equals PLAYER | PASSED");
  }

  @Test
  public void getExecutableCode() {
    Assert.assertEquals("test", reward.getExecutableCode());
    System.out.println("> Reward#getExecutableCode true for equals 'test' | PASSED");
  }

  @Test
  public void getChance() {
    Assert.assertEquals(10, reward.getChance(), 0);
    System.out.println("> Reward#getChance equals 10% delta 0 | PASSED");
  }

  @Test
  public void getWaveExecute() {
    Assert.assertEquals(-1, reward.getWaveExecute());
    System.out.println("> Reward#getWaveExecute equals -1 | PASSED");
  }

  @Test
  public void getType() {
    Assert.assertEquals(Reward.RewardType.END_GAME, reward.getType());
    System.out.println("> Reward#getType equals END_GAME | PASSED");
  }
